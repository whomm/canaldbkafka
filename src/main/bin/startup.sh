...
then 
	...
	$JAVA $JAVA_OPTS $JAVA_DEBUG_OPT $CANAL_OPTS -classpath .:$CLASSPATH com.baidu.dbevent.canal.order.ClusterCanalClient $destination $topic $canalhazk $kafka 1>>$base/bin/nohup.out 2>&1 &
